...
| Remaining scope/reference coverage (`this`, named dynamic refs, edge cases) | Analysis + LSP               | Next             | The biggest remaining gap is the still-deferred scope edge cases outside the shipped bounded selector / dotted-reference slice.                                   |
