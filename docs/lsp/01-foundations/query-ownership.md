...
- [`crates/strz-grammar/queries/highlights.scm`](../../../crates/strz-grammar/queries/highlights.scm)
- [`crates/strz-grammar/queries/folds.scm`](../../../crates/strz-grammar/queries/folds.scm)
- [`crates/strz-grammar/queries/indents.scm`](../../../crates/strz-grammar/queries/indents.scm)
...
- `tags.scm` should be added under [`crates/strz-grammar/queries/`](../../../crates/strz-grammar/queries/) in this repository when the symbol-extraction work begins
...
- [`crates/strz-grammar/queries/`](../../../crates/strz-grammar/queries/)
