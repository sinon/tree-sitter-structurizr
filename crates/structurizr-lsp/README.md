...
`structurizr-lsp` is the in-repo stdio language server for Structurizr DSL editor features.

It stays intentionally thin:

- `structurizr-analysis` owns extracted document and workspace facts
