...
proptest::proptest! {
    ...
    fn repeated_analysis_is_deterministic(source in analysis_source()) {
        ...
        proptest::prop_assert_eq!(first.workspace_sections(), second.workspace_sections());
        proptest::prop_assert_eq!(first.configuration_scopes(), second.configuration_scopes());
        proptest::prop_assert_eq!(first.property_facts(), second.property_facts());
        proptest::prop_assert_eq!(first.resource_directives(), second.resource_directives());
        proptest::prop_assert_eq!(first.element_directives(), second.element_directives());
        proptest::prop_assert_eq!(first.view_facts(), second.view_facts());
    }
