...
workspace "Big Bank plc - Internet Banking System" "The software architecture of the Big Bank plc Internet Banking System." {
    ...
    model {
        ...
        <CURSOR:customer-relationship>customer -> <CURSOR:web-application-relationship>webApplication "Visits bigbank.com/ib using" "HTTPS"
        ...
        deploymentEnvironment "Development" {
            deploymentNode "Developer Laptop" "" "Microsoft Windows 10 or Apple macOS" {
                ...
                deploymentNode "Docker Container - Web Server" "" "Docker" {
                    deploymentNode "Apache Tomcat" "" "Apache Tomcat 8.x" {
                        developerWebApplicationInstance = containerInstance <CURSOR:web-application-instance>webApplication
            ...
            deploymentNode "Big Bank plc" "" "Big Bank plc data center" "" {
                deploymentNode "bigbank-dev001" "" "" "" {
                    softwareSystemInstance <CURSOR:mainframe-instance>mainframe
                }
            }
        }
            ...
            deploymentNode "Big Bank plc" "" "Big Bank plc data center" {
                ...
                deploymentNode "bigbank-db01" "" "Ubuntu 16.04 LTS" {
                    primaryDatabaseServer = deploymentNode "Oracle - Primary" "" "Oracle 12c" {
                        <CURSOR:live-primary-database-instance>livePrimaryDatabaseInstance = containerInstance database
                    }
                }
    ...
    views {
        systemcontext internetBankingSystem "SystemContext" {
            include internetBankingSystem <CURSOR:include-customer>customer mainframe email
            animation {
        ...
        container internetBankingSystem "Containers" {
            ...
            animation {
                ...
                <CURSOR:container-animation-web>webApplication
        ...
        dynamic <CURSOR:dynamic-view>apiApplication "SignIn" "Summarises how the sign in feature works in the single-page application." {
            <CURSOR:single-page-application>singlePageApplication -> <CURSOR:signin-controller>signinController "Submits credentials to"
            signinController -> <CURSOR:security-component>securityComponent "Validates credentials using"
        ...
        deployment internetBankingSystem "Development" "DevelopmentDeployment" {
            include <CURSOR:animation-spa>developerSinglePageApplicationInstance <CURSOR:animation-web>developerWebApplicationInstance developerApiApplicationInstance developerDatabaseInstance
            animation {
