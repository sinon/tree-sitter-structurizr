workspace "Amazon Web Services Example" "An example AWS deployment architecture." {
    ...
    model {
        springPetClinic = softwaresystem "Spring PetClinic" "An example application." "Spring Boot Application" {
            webApplication = container "Web Application" "A web app." "Java and Spring Boot"
            database = container "Database" "A database." "Relational database schema" "Database"
